...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align: center;"><router-link to="/installing-trollhelperota">TrollHelperOTA</router-link></td>
    </tr>
    <tr>
      <td style="text-align: center; font-weight: bold;">15.0</td>
      <td style="text-align: center; font-weight: bold;">15.5 beta 4</td>
      <td style="text-align: center;" colspan="2"><router-link to="/installing-trollhelperota">TrollHelperOTA</router-link></td>
    </tr>
    <tr>
